...
if [ ! -d "/app/data/data" ]; then
	...
	sudo mkdir -p /app/data/data/custom
fi
sudo chmod 777 /app/data/data
sudo chmod 777 /app/data/data/custom
sudo chmod 777 /app
...
cd /app/data
../forgejo-11.0.0-linux-amd64 --config /app/data/data/custom/app.ini --data-path /app/data/data